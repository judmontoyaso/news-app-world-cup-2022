...
export default function ActiveRopute({ children, href }) {
  ...
  const color =
    router.pathname === href
      ? "cursor-pointer lg:mr-8 lg:inline-flex lg:w-auto w-full px-3 py-2 rounded-2xl text-black font-bold items-center justify-center dark:text-blue-300    text-gray-700 border-green-500 dark:text-white  lg:mt-0 mt-4"
