      ...
      <div className="max-w-4xl px-4 mx-auto text-gray-700 dark:text-gray-300">
        ...
        <div className="flex flex-col justify-between lg:flex-row items-center">
          ...
          <p className="text-xs ml-3">
            Built with Next.js, Tailwind and deploy on Vercel, by <a href="https://juandeveloper.ninja" className={"transition-colors hover:text-yellow-500"}>JuanDeveloper.ninja</a>
          </p>
        </div>
      </div>
    </div>
